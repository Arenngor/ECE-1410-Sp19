...
-----------------------------------------------------------------------------------------
Pseudo:
Create an output, with static casting of circles output
Then add into the output, height, area and volume
Then return the output for printing
*****************************************************************************************/
ostream &operator<<(ostream &output, const Cylinder &c)

{
	
	output << static_cast<Circle>(c)						// Output Cylinder dimensions

		<< "; Height = " << c.height << "; Area = " << c.area() << "; Volume = " << c.volume();
